...
namespace MoreUsers.Controllers
{
    public class EmployeesController : Controller
    {
        ...
        public EmployeesController(UserManager<ApplicationUser> userManager, IEmployeeService service)
        {
        ...
        public async Task<ActionResult> Create(CreateEmployeeViewModel employee)
        {
            ...
            if (await userManager.FindByNameAsync(employee.Username) == null)
            {
                ...
                if (result.Succeeded)
                {
                    var created = service.CreateEmployee(employee.FirstName, employee.LastName, employee.Phone, employee.JobTitle, user.Id);
